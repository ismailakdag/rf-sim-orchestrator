...
CST_LIBS = r"E:\CST Studio Suite 2026\AMD64\python_cst_libraries"
...
def run(job_path: Path) -> int:
    ...
    record: dict[str, Any] = {
        ...
        "call_timeouts_seconds": {
            ...
            "connect": None,
            "connect_note": "CST 2026 connect API exposes no per-call timeout; parent process supervises this worker.",
        },
    ...
    try:
        ...
        record["simulator"] = {"product": "CST Studio Suite", "version": "2026", "api": "official local Python interface"}
        record["source_version"] = "fr4-g5-fixtured-loop-v2"
        ...
        record["mesh_control"] = {
            ...
            "evidence": "CST 2026 shipped vba_snippets.py Hex template and Global Mesh Properties Refine help",
